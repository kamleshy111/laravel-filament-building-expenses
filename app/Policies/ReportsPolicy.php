...
class ReportsPolicy
{
    ...
    {
        return $user->can('view_any_reports');
    }
    ...
    {
        return $user->can('delete_any_reports');
    }
    ...
    {
        return $user->can('force_delete_reports');
    }
    ...
    {
        return $user->can('force_delete_any_reports');
    }
    ...
    {
        return $user->can('restore_reports');
    }
    ...
    {
        return $user->can('restore_any_reports');
    }
    ...
    {
        return $user->can('replicate_reports');
    }
    ...
    {
        return $user->can('reorder_reports');
    }
}
