...
class BuildingsPolicy
{
     ...
     */
    public function view(User $user, Buildings $buildings): bool
    {
     ...
     */
    public function update(User $user, Buildings $buildings): bool
    {
     ...
     */
    public function delete(User $user, Buildings $buildings): bool
    {
     ...
     */
    public function forceDelete(User $user, Buildings $buildings): bool
    {
     ...
     */
    public function restore(User $user, Buildings $buildings): bool
    {
     ...
     */
    public function replicate(User $user, Buildings $buildings): bool
    {
